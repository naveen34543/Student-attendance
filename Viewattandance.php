...
<head>
    ...
    <link rel="stylesheet" href="Viewattandance.css">
    <title>EASC</title>
</head>
    ...
    <form id="formtwo" method="post">
        <table>
            <tr>
                ...
                <th>Year</th>
                <th>Semester</th>
                <th>Student no.of present Hrs</th>
                <th>Student no.of present Days</th>
            </tr>
            <?php
            ...
            if (isset($_POST["submit"])) {
                ...
                $sthRegister = $con->prepare("SELECT * FROM `studenntregister` WHERE course = :course AND year = :year ORDER BY reg");
                ...
                while ($rowRegister = $sthRegister->fetch()) {
                    $rowAttendance = $sthAttendance->fetch(); // Fetch attendance separately
            ...
            if (isset($_POST["search"])) {
                ...
                $sthReg = $con->prepare("SELECT * FROM `studenntregister` WHERE reg = :reg");
